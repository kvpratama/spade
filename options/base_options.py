...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--load_size', type=int, default=2048, help='Scale images to this size. The final image will be cropped to --crop_size.')
        parser.add_argument('--crop_size', type=int, default=2048, help='Crop to the width of crop_size (after initially scaling the images to load_size.)')
        ...
        parser.add_argument('--gtroot', type=str, default='./datasets/cityscapes/')
        ...
        parser.add_argument('--isTrain', action='store_true', help='Training phase')
        parser.add_argument('--isVal', action='store_true', help='Validation phase')

        parser.add_argument('--input_min_max', type=str, default='', help='min max input for normalization')
        parser.add_argument('--output_min_max', type=str, default='', help='min max output for normalization')
        parser.add_argument('--norm_method', type=str, default='minmax', help='standardization, prof_norm, minmax')
        parser.add_argument('--nval', type=int, default=100, help='Number of val data')
